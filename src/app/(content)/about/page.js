    ...
    return (
            <>
                <div className="about-content-wrapper">
                    <div className="about-cover-image-container">
                        <Image src={image} fill className="about-cover-image" alt="image of Jadyn"></Image>
                    </div>
                    ...
                    <div className="about-content-block">
                        <div className="about-title">What is “Life With Lam”?</div>
                        <p className="about-text-wrapper">
